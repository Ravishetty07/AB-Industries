...
export default function CncMachiningPage() {
  return (
    <main className="overflow-hidden">
      ...
      <section className="py-28 bg-gradient-to-br from-white via-slate-50 to-blue-50 relative overflow-hidden">
        {/* Background Blur Shapes */}
        <div className="absolute -top-20 right-10 w-[400px] h-[400px] bg-blue-200/20 rounded-full blur-3xl" />
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <Image
                ...
                alt="Inspection & CMM Quality Control"
                width={600}
                height={400}
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-slate-900/80 to-transparent p-5">
                <h3 className="text-white font-semibold text-lg">
                  Advanced CMM & Digital Inspection
                </h3>
                <p className="text-blue-100 text-sm">
                  Every component validated with 3D precision measurement
                  systems.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold mb-5 text-slate-900">
                Unmatched{" "}
                <span className="text-blue-600">Precision Control</span>
              </h2>
              <p className="text-slate-700 mb-6 text-lg leading-relaxed">
                At AB Industries, precision is built into every step of our
                process. From CNC machining to final inspection, our ISO
                9001:2015-certified system ensures consistency, traceability,
                and reliability.
              </p>
              ...
              <div className="space-y-5">
                {[
                  {
                    icon: "🧭",
                    title: "CMM Measurement Accuracy",
                    desc: "High-precision 3D inspection to ±2 microns.",
                  },
                  {
                    icon: "📊",
                    title: "Digital Quality Reports",
                    desc: "Automated inspection data linked to every batch.",
                  },
                  {
                    icon: "🏷️",
                    title: "Material Traceability",
                    desc: "Barcode and lot-based tracking from raw stock to shipment.",
                  },
                ].map((point, i) => (
                  <div
                    key={i}
                    className="flex items-start bg-white/70 backdrop-blur-sm border border-blue-100 rounded-xl p-4 hover:shadow-md transition-all"
                  >
